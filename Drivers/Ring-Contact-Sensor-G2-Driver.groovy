...
metadata {
    ...
    definition (name: "Ring Alarm Contact Sensor G2 - Advanced Driver", namespace: "MikeNYC88", author: "Mike Dam", importUrl: "https://github.com/mikenyc88/Hubitat/blob/main/Drivers/Ring-Contact-Sensor-G2-Driver") {
