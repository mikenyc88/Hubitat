...
metadata {
    definition (name: "Ring Alarm Keypad G2 - Advanced Driver", namespace: "MikeNYC88", author: "Mike Dam", importUrl: "https://github.com/mikenyc88/Hubitat/blob/main/Drivers/Ring-Keypad-G2-Driver") { //Added MikeNYC Edit to name
        capability "Actuator"
        capability "Sensor"
